...
cur.execute("SET @sqlstr = CONCAT('create table if not exists rename_',DATE_FORMAT(CURDATE(),'%Y%m%d'),' (hostname varchar(20),filename_old varchar(45), filename_new varchar(45), systemtime varchar(14), filetime varchar(14),roomnumber varchar(10) )')")
